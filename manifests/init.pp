...
class cfssl (
  ...
  String                $cr_server_expire        = $cfssl::params::cr_server_expire,
  String                $cr_client_expire        = $cfssl::params::cr_client_expire,
  String                $cr_client_server_expire = $cfssl::params::cr_client_server_expire,
